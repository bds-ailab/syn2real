...
- we delete the label of some segments randomely to force the model to learn the object class just from its shape & the context and not from the color (label Id) \
