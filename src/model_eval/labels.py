...
labels = [
    ...
    Label("terrain", 7, 9, "nature", 4, False, False, (152, 251, 152)),
    Label("sky", 8, 10, "sky", 5, False, False, (70, 130, 180)),
    Label("person", 9, 11, "human", 6, True, False, (220, 20, 60)),
    Label("car", 10, 13, "vehicle", 7, True, False, (0, 0, 142)),
    Label("truck", 11, 14, "vehicle", 7, True, False, (0, 0, 70)),
    Label("bus", 12, 15, "vehicle", 7, True, False, (0, 60, 100)),
]
