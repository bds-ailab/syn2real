...
def main(arg_list=None):
    ...
    imgs_list = os.listdir(args.input_image)

    os.makedirs(args.output_dir, exist_ok=True)
    for input_image_path in imgs_list:
        pth = os.path.join(args.input_image, input_image_path)
        ...
        output_pil = output_pil.resize(
            (input_image.width, input_image.height), Image.LANCZOS
        )
